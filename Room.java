...
public class Room {
    ...
    /** Given a Scanner object positioned at the beginning of a "room" file
     ...
     @param s holds the current location of the text file to be read into the Dungeon
     ...
     @param light, determines whether the room has a light at the room's construction
     */
    ...
    /**
     * @return, returns true or false regarding whether the room has a source of light turned on
     */
    public boolean getLight(){return}
}
